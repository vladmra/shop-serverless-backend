...
- Test .csv file for upload can be found here - [mock-products.csv](./src/libs/mock-products.csv)
...
E.g. create `.env` file in `./import-service` directory, with contents like
...
As "import-service" uses lambda-proxy integration with API Gateway, CORS settings should be specified in the lambda handle function response as well.
